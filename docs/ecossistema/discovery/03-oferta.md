...
- **Ponte com equity (longo prazo):** nos casos certos, evoluir performance → participação (conecta com a tese Venture Builder).

## 6. Garantia (risk reversal — ataca a ferida do mercado)
O mercado está queimado com promessa vazia. Garantia ancorada em **ENTREGA**, não em resultado vago:
> **"Em 60 dias sua máquina está implementada e rodando — os 4 pilares entregues e funcionando. Se eu não entregar o que está no escopo, você não paga o setup / [risk reversal a definir]."**
Garantia de entrega > garantia de resultado (que ninguém honesto promete). Diferencia do "copia e cola" das mentorias.

## 7. Stack de bônus (aumenta valor percebido sem aumentar custo — alavanca IA)
- Os agentes/automações de IA configurados ficam **rodando** pro cliente (ativo, não aula).
- Templates de copy/landing/conteúdo gerados.
- Dashboard de métricas comerciais.

## 8. Para quem é / NÃO é
- **É:** empresário com negócio rodando (tem o que estruturar e caixa pra investir) e profissional liberal querendo escalar além da hora vendida.
- **NÃO é:** iniciante sem base, quem só quer aprender (ensino), quem não tem caixa. (Alinhado ao doc de posicionamento.)

## 9. CTA
Aplicação + diagnóstico (não checkout). Coerente com venda consultiva high-ticket do mercado e com o CTA "DM/aplicação" do doc de posicionamento.

---
## ⚠️ Pontos a refinar (squad, depois)
- Clone Hormozi: afiar garantia, naming, e a "oferta que não dá pra recusar".
- @pm: travar preço final e o modelo (fee vs performance vs equity) por ICP.
- Decisão Fase 5: o que é núcleo vs add-on (capacidade).
