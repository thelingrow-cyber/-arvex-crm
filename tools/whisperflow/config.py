...
DEFAULT_CONFIG = {
    ...
    # own name and its main competitor's, likely to keep coming up. Edit
    # freely; this list feeds the Whisper initial_prompt as a soft bias,
    # not a hard dictionary (AD-2 pattern).
    "custom_vocabulary": ["Wispr Flow", "WhisperFlow", "ARVEX"],
}
